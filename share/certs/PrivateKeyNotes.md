...
unlocked to sign the Truthcoin-Qt.app bundle.
...
allowing somebody to distribute a Truthcoin-Qt.app or truthcoin-qt-setup.exe with a valid
...
that the truthcoin-qt.exe file inside the installer had not been tampered with.
