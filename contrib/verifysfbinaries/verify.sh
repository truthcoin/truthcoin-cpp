...
###   This script attempts to download the signature file SHA256SUMS.asc from truthcoin.org
...
WORKINGDIR="/tmp/truthcoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://truthcoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://truthcoin.org/bin/"
VERSIONPREFIX="truthcoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'truthcoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[truthcoin-]<version>-[rc[0-9]] (example: truthcoin-0.9.2-rc1)"
   echo "wget output:"
