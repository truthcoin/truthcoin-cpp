...
/* FDLIBM___ieee754_j1(x), FDLIBM___ieee754_y1(x)
...
#ifdef __STDC__
	double FDLIBM___ieee754_j1(double x) 
#else
	double FDLIBM___ieee754_j1(x) 
	double x;
#endif
{
...
#ifdef __STDC__
	double FDLIBM___ieee754_y1(double x) 
#else
	double FDLIBM___ieee754_y1(x) 
	double x;
#endif
{
	...
	if(ix>=0x7ff00000) return  one/(x+x*x); 
        ...
        return(x*(u/v) + tpi*(FDLIBM___ieee754_j1(x)*FDLIBM___ieee754_log(x)-one/x));
}
