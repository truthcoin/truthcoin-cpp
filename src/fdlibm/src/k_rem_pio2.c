...
/*
 * FDLIBM___kernel_rem_pio2(x,y,e0,nx,prec,ipio2)
...
#ifdef __STDC__
	int FDLIBM___kernel_rem_pio2(double *x, double *y, int e0, int nx, int prec, const int *ipio2) 
#else
	int FDLIBM___kernel_rem_pio2(x,y,e0,nx,prec,ipio2) 	
	double x[], y[]; int e0,nx,prec; int ipio2[];
#endif
{
