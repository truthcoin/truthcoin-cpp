...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CTruthcoinAddress demoAddress = CTruthcoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CTruthcoinAddress setaccountDemoAddress = CTruthcoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CTruthcoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CTruthcoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
