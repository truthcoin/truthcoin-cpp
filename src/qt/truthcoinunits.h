...
#ifndef TRUTHCOIN_QT_TRUTHCOINUNITS_H
#define TRUTHCOIN_QT_TRUTHCOINUNITS_H
...
/** Truthcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class TruthcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit TruthcoinUnits(QObject *parent);

    /** Truthcoin units.
      @note Source: https://en.truthcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CSH,
...
typedef TruthcoinUnits::Unit TruthcoinUnit;

#endif // TRUTHCOIN_QT_TRUTHCOINUNITS_H
