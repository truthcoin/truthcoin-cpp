...
#ifndef TRUTHCOIN_QT_TRUTHCOINGUI_H
#define TRUTHCOIN_QT_TRUTHCOINGUI_H
...
/**
  Truthcoin GUI main class. This class represents the main window of the Truthcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class TruthcoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit TruthcoinGUI(const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~TruthcoinGUI();
...
#endif // TRUTHCOIN_QT_TRUTHCOINGUI_H
