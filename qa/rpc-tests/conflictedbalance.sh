...
if [ $# -lt 1 ]; then
        ...
        echo "e.g. $0 ../../src"
        echo "Env vars TRUTHCOIND and TRUTHCOINCLI may be used to specify the exact binaries used"
        exit 1
fi

set -f

TRUTHCOIND=${TRUTHCOIND:-${1}/truthcoind}
CLI=${TRUTHCOINCLI:-${1}/truthcoin-cli}
