Truthcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/truthcoin/files/Truthcoin/truthcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Truthcoin
...
New/changed settings (command-line or truthcoin.conf file)
--------------------------------------------------------
