Truthcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/truthcoin/files/Truthcoin/truthcoin-0.5.4/
...
http://gitorious.org/truthcoin/truthcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Truthcoin-Qt notifications under Growl 1.3.
Increase required age of Truthcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxTruthcoin properly when installing Truthcoin-Qt over it. (Windows)
